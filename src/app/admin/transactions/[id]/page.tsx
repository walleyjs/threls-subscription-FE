        ...
        <Card className="md:col-span-2">
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>
                Details of transaction {transaction.invoiceNumber}
              </CardDescription>
            </div>
            <div className="flex items-center">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Expires{" "}
                    {transaction.paymentMethodDetails.expiryMonth
                      .toString()
                      .padStart(2, "0")}
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Details of the related subscription
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
              ...
              {transaction.subscriptionId && (
                <>
                  <div>
                    ...
                    <p className="font-medium">
                      {transaction.subscriptionId?.planId?.name}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-muted-foreground">
                  ...
                  <div>
                    ...
                    <p className="font-medium capitalize">
                      {transaction.subscriptionId.status}
                    </p>
                  </div>
                </>
              )}
              <Button
                ...
                onClick={() =>
                  router.push(
                    `/admin/subscribers/${transaction.subscriptionId._id}`
                  )
                }
              >
                View Subscription
